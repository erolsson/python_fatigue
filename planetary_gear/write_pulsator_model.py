...
if __name__ == '__main__':
    ...
    for load_amp in load_amplitudes:
        ...
        file_lines += write_load_step('Amplitude_Pamp=' + str(load_amp) + 'kN_min', force=(mean_load-load_amp)*1000)

    for load_amp in load_amplitudes:
        mean_load = (1 + load_ratio)/(1-load_ratio)*load_amp
        file_lines += write_load_step('Amplitude_Pamp=' + str(load_amp) + 'kN_max', force=(mean_load+load_amp)*1000)
