...
if __name__ == '__main__':
    ...
    file_lines += write_load_step('Apply_load', applied_torque=-torque*torque_ratio/2,
                                  torque_gear_name='ring')

    for i in range(4):
        file_lines += write_load_step('loading_tooth_' + str(i+1), applied_torque=-torque*torque_ratio/2,
