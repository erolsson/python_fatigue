...
class DilatometerSimulation:
    ...
    def _write_mechanical_file(self):
        file_lines = ['**',
                      ...
                      '\t Quenching a dilatometer experiment',
                      '\t*STATIC, DIRECT',
                      '\t\t0.001,  ' + str(self.quench_time) + ', 1e-05,  ' + str(self.quench_time/500),
...
if __name__ == '__main__':
    ...
    dilatometer = DilatometerSimulation(carbon=0.8, material='U925064', directory='dilatormeter', cooling_rate=cooling)
    simulation_data = dilatometer.run()
