...
if __name__ == '__main__':
    ...
    for carbon_level, color in zip([0.2, 0.36, 0.52, 0.65], ['k', 'b', 'm', 'r']):
        dilatometer = DilatometerSimulation(carbon=carbon_level, material='S86XX', directory='dilatormeter',
    ...
    dilatometer = DilatometerSimulation(carbon=0.8, material='S86XX', directory='dilatormeter', cooling_rate=cooling)
    simulation_data = dilatometer.run()
