...
specimen_name = 'roller'
times = [300, 90]
temps = [930, 850]
carbon_levels = [1.1, 0.75]
tempering = (170, 7200)
...
simulation_directory = os.path.expanduser('~/rolling_contact/heat_treatment/dante_simulation/')
...
geometry_file_name = '../rolling_contact/input_files/roller.inp'
...
bc_file = '../rolling_contact/input_files/roller_bc.inc'
