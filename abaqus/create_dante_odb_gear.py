...
if __name__ == '__main__':
    ...
    simulation_directory = '/scratch/users/erik/scania_gear_analysis/VBC_gear/U92504_200C_2h_90C_cool_20190412/'
    ...
    odb_file_name = dante_odb_path + 'dante_results_tempering_2h_200C.odb'
